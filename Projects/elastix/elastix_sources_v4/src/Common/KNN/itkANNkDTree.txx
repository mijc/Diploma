...
#ifndef __itkANNkDTree_txx
#define __itkANNkDTree_txx
...
namespace itk
{
    ...
    ::GetSplittingRule( void )
  {
    switch ( this->m_SplittingRule )
    {
      ...
      case ANN_KD_MIDPT:    return "ANN_KD_MIDPT";
      case ANN_KD_FAIR:     return "ANN_KD_FAIR";
      case ANN_KD_SL_MIDPT: return "ANN_KD_SL_MIDPT";
...
#endif // end #ifndef __itkANNkDTree_txx
