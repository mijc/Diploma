...
=========================================================================*/
#ifndef __itkAffineDTI3DTransform_txx
#define __itkAffineDTI3DTransform_txx
...
::ComputeMatrix( void )
{
  ...
  MatrixType ShearX;
  ShearX[0][0]=1;ShearX[0][1]=0;ShearX[0][2]=gx;
  ShearX[1][0]=0;ShearX[1][1]=1;ShearX[1][2]=0;
  ShearX[2][0]=0;ShearX[2][1]=0;ShearX[2][2]=1;

  MatrixType ShearY;
  ShearY[0][0]=1;ShearY[0][1]=0;ShearY[0][2]=0;
  ShearY[1][0]=gy;ShearY[1][1]=1;ShearY[1][2]=0;
  ShearY[2][0]=0;ShearY[2][1]=0;ShearY[2][2]=1;

  MatrixType ShearZ;
  ShearZ[0][0]=1;ShearZ[0][1]=0;ShearZ[0][2]=0;
  ShearZ[1][0]=0;ShearZ[1][1]=1;ShearZ[1][2]=0;
  ShearZ[2][0]=0;ShearZ[2][1]=gz;ShearZ[2][2]=1;

  MatrixType Scale;
  Scale[0][0]=ssx;Scale[0][1]=0;Scale[0][2]=0;
  Scale[1][0]=0;Scale[1][1]=ssy;Scale[1][2]=0;
  Scale[2][0]=0;Scale[2][1]=0;Scale[2][2]=ssz;

  this->SetVarMatrix(
    RotationX * RotationY * RotationZ *
    ShearX * ShearY * ShearZ * Scale );
...
::PrecomputeJacobianOfSpatialJacobian( void )
{
  ...
  MatrixType ScaleX;
  ScaleX[0][0]=ssx;ScaleX[0][1]=0;ScaleX[0][2]=0;
  ScaleX[1][0]=0;ScaleX[1][1]=1;ScaleX[1][2]=0;
  ScaleX[2][0]=0;ScaleX[2][1]=0;ScaleX[2][2]=1;

  MatrixType ScaleY;
  ScaleY[0][0]=1;ScaleY[0][1]=0;ScaleY[0][2]=0;
  ScaleY[1][0]=0;ScaleY[1][1]=ssy;ScaleY[1][2]=0;
  ScaleY[2][0]=0;ScaleY[2][1]=0;ScaleY[2][2]=1;

  MatrixType ScaleZ;
  ScaleZ[0][0]=1;ScaleZ[0][1]=0;ScaleZ[0][2]=0;
  ScaleZ[1][0]=0;ScaleZ[1][1]=1;ScaleZ[1][2]=0;
  ScaleZ[2][0]=0;ScaleZ[2][1]=0;ScaleZ[2][2]=ssz;
  ...
  MatrixType ShearXd;
  ShearXd[0][0]=0;ShearXd[0][1]=0;ShearXd[0][2]=1;
  ShearXd[1][0]=0;ShearXd[1][1]=0;ShearXd[1][2]=0;
  ShearXd[2][0]=0;ShearXd[2][1]=0;ShearXd[2][2]=0;

  MatrixType ShearYd;
  ShearYd[0][0]=0;ShearYd[0][1]=0;ShearYd[0][2]=0;
  ShearYd[1][0]=1;ShearYd[1][1]=0;ShearYd[1][2]=0;
  ShearYd[2][0]=0;ShearYd[2][1]=0;ShearYd[2][2]=0;

  MatrixType ShearZd;
  ShearZd[0][0]=0;ShearZd[0][1]=0;ShearZd[0][2]=0;
  ShearZd[1][0]=0;ShearZd[1][1]=0;ShearZd[1][2]=0;
  ShearZd[2][0]=0;ShearZd[2][1]=1;ShearZd[2][2]=0;

  MatrixType ScaleXd;
  ScaleXd[0][0]=1;ScaleXd[0][1]=0;ScaleXd[0][2]=0;
  ScaleXd[1][0]=0;ScaleXd[1][1]=0;ScaleXd[1][2]=0;
  ScaleXd[2][0]=0;ScaleXd[2][1]=0;ScaleXd[2][2]=0;

  MatrixType ScaleYd;
  ScaleYd[0][0]=0;ScaleYd[0][1]=0;ScaleYd[0][2]=0;
  ScaleYd[1][0]=0;ScaleYd[1][1]=1;ScaleYd[1][2]=0;
  ScaleYd[2][0]=0;ScaleYd[2][1]=0;ScaleYd[2][2]=0;
  ...
  jsj[1] = RotationX * RotationYd * RotationZ *
    ShearX * ShearY * ShearZ * ScaleX * ScaleY * ScaleZ;
  jsj[2] = RotationX * RotationY * RotationZd *
    ShearX * ShearY * ShearZ * ScaleX * ScaleY * ScaleZ;
  jsj[3] = RotationX * RotationY * RotationZ *
    ShearXd * ShearY * ShearZ * ScaleX * ScaleY * ScaleZ;
  jsj[4] = RotationX * RotationY * RotationZ *
    ShearX * ShearYd * ShearZ * ScaleX * ScaleY * ScaleZ;
  jsj[5] = RotationX * RotationY * RotationZ *
    ShearX * ShearY * ShearZd * ScaleX * ScaleY * ScaleZ;
  jsj[6] = RotationX * RotationY * RotationZ *
    ShearX * ShearY * ShearZ * ScaleXd * ScaleY * ScaleZ;
  jsj[7] = RotationX * RotationY * RotationZ *
